...
/// <summary>
/// Handles player movement, input processing, and interaction with the game world.
...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("Reference to the hex grid system")]
    public HexGrid grid;

    [Header("Position")]
    [Tooltip("Current X position on the grid")]
    public int gridX = 0;

    [Tooltip("Current Y position on the grid")]
    public int gridY = 0;
